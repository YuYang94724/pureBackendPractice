...
public interface WalletTransactionRepository extends JpaRepository<WalletTransactionPO, Long>, JpaSpecificationExecutor<WalletTransactionPO> {
    ...
    @Query(value = "SELECT " +
            "new com.yuyang.pureBackendPractice.wallet.data.vo.WalletVO(wt.id, m.username, wt.operationUuid, wt.operationType, wt.beforeBalance, wt.amount, wt.afterBalance, wt.createdBy, wt.createdDate, wt.lastModifiedBy, wt.lastModifiedDate) " +
